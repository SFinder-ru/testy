...
class Project(models.Model):
    ...
    part_users = models.ManyToManyField('PartUsers', blank=True,
                                        default='Отсутствуют',
...
class PartUsers(models.Model):
    part_users = models.ManyToManyField('User', default='Отсутствуют',
                                        verbose_name="Участники проекта")
    role = models.ForeignKey('Roles', blank=True, on_delete=models.PROTECT,
...
class Roles(models.Model):
    role = models.CharField(max_length=100, default='Участник', blank=True)
