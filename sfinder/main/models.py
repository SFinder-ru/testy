...
class AdvUser(AbstractUser):
    ...
    vk_link = models.URLField(max_length=150, blank=True,
                              verbose_name='Ссылка на VK')
    fav_users = models.ManyToManyField('AdvUser', blank=True, related_name='user_favourites',
    ...
    def get_all_users(self):
        all_users_list = AdvUser.objects.all()
        all_users_str = ''
...
class Comment(models.Model):
    ...
    user_name = models.ForeignKey('AdvUser', on_delete=models.SET_DEFAULT,
                                  default='0',
...
class Project(models.Model):
    ...
    part_users = models.ManyToManyField('AdvUser', blank=True, related_name='+',
                                        verbose_name='Участники проекта')
    creators = models.ManyToManyField('AdvUser', verbose_name='Создатели проекта',
    ...
    def get_technologies(self):
        tech_list = self.technologies.get_queryset()
        tech_str = ''
        for tech in tech_list:
            tech_str += ', ' + tech.__str__()
        return tech_str.lstrip(', ')

    get_technologies.short_description = 'Технологии проекта'
